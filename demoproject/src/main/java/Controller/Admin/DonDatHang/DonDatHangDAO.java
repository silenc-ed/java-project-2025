...
public class DonDatHangDAO {
        ...
        try {
            ...
            if (serials != null && !serials.isEmpty()) {
                String sqlCT = "INSERT INTO CHI_TIET_HOA_DON (MA_HD, MA_SP, SERIAL_NUMBER, SO_LUONG, DON_GIA, THANH_TIEN) " +
                               "VALUES (?, ?, ?, ?, ?, ?)";
                String sqlSerial = "UPDATE KHO_SERIAL SET TRANG_THAI = N'Đang được đặt' WHERE SERIAL_NUMBER = ? AND TRANG_THAI = N'Trong kho'";
    ...
    public void updateOrder(int maHD, Integer maKH,
        ...
        try {
            ...
            // Release serial cũ
            String sqlReleaseOld = "UPDATE KHO_SERIAL SET TRANG_THAI = N'Trong kho' " +
    ...
    public void cancelOrder(int maHD, String lyDoHuy) throws Exception {
        ...
        try {
            ...
            // Release serial về Trong kho
            String sqlRelease = "UPDATE KHO_SERIAL SET TRANG_THAI = N'Trong kho' " +
                                "WHERE SERIAL_NUMBER IN (SELECT SERIAL_NUMBER FROM CHI_TIET_HOA_DON WHERE MA_HD = ? AND SERIAL_NUMBER IS NOT NULL)";
    ...
    /**
     * Tìm serial khả dụng (TRANG_THAI = 'Trong kho')
     */
    public List<Map<String, Object>> searchAvailableSerials(String keyword) throws Exception {
        ...
        String sql = "SELECT KS.MA_SN, KS.SERIAL_NUMBER, KS.MA_BIENTHE, BT.MA_SP, SP.TEN_SP, BT.TEN_BIENTHE, BT.GIA_BAN " +
                     ...
                     "WHERE KS.TRANG_THAI = N'Trong kho' " +
    ...
    public List<Map<String, Object>> searchVariantsForRepair(String keyword) throws Exception {
        ...
        String sql = "SELECT BT.MA_BIENTHE, SP.MA_SP, SP.TEN_SP, BT.TEN_BIENTHE, BT.GIA_BAN, " +
                     ...
                     "   (SELECT COUNT(*) FROM KHO_SERIAL KS WHERE KS.MA_BIENTHE = BT.MA_BIENTHE AND KS.TRANG_THAI = N'Trong kho') " +
                     " ELSE " +
    ...
    public List<String> getAvailableSerialsForVariant(int maBienThe) throws Exception {
        ...
        String sql = "SELECT SERIAL_NUMBER FROM KHO_SERIAL WHERE MA_BIENTHE = ? AND TRANG_THAI = N'Trong kho'";
        try (Connection con = ConnectionUtils.getMyConnection();
             PreparedStatement ps = con.prepareStatement(sql)) {
